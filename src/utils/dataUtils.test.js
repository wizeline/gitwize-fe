...
describe('filterObjectByKey', () => {
  ...
  test('Return enough data', () => {
    expect(filterObjectByKey(transformedData, ["Commits", "Merged", "Rejected"]).length).toBe(9)
    expect(filterObjectByKey(transformedData, ["Deletions", "Additions", "Total lines of code"]).length).toBe(9)
  })
